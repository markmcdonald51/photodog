class AttachmentsController < ApplicationController
  ...
  private
    ...
    def attachment_params
      params.require(:attachment).permit(:title, :altitude, :latitude, :longitude, :image_views, :photo_taken_time, :url, :description, :device_id, :user_id, :attachable_id, :attachable_type, :type)
    end
end
